export function Hero() {
	return (
		<section className="relative flex min-h-screen items-center justify-center bg-linear-to-br from-slate-950 via-slate-900 to-slate-950 px-4 py-20 transition-all duration-1000 hover:bg-size-[400%_400%]">
			{/* Decorative elements */}
